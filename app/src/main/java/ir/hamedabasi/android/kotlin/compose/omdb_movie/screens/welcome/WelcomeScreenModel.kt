...
sealed class WelcomeScreenModel(val image: Int,val title: String,val description: String) {
    ...
    data object PageSearch : WelcomeScreenModel(R.mipmap.search, "Accurate Searching", "Here you can search any movie any time, we have used an comprehensive database !")
